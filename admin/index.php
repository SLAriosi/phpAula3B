...
<body id="page-top">
    ...
    if ($usuarioNaoExiste) {
        ...
        if (isset($_GET['param'])) {
            // Hoje ela está desse jeito -> paginas/home
            ...
            // Essa estrutura de condição define qual página eu irei entrar dependendo da rota que eu utilizar 
            // nesse exemplo caso a rota que eu passe exista, o código irá me enviar diretamente a aquela página,
            // agora caso não exista essa condição irá me levar até uma página de erro pré programada.
